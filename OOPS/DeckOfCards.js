...
for(let i=0;i<final.player1.length;i++)
{
    Queue.enqueue(final.player1[i]);
}
//console.log(Queue.printQueue());
//console.log("---------------------------------------------------------");

for(let i=0;i<final.player2.length;i++)
{
    Queue.enqueue(final.player2[i]);
}
//console.log(Queue.printQueue());
//console.log("---------------------------------------------------------");

for(let i=0;i<final.player3.length;i++)
{
    Queue.enqueue(final.player3[i]);
}
//console.log(Queue.printQueue());
//console.log("---------------------------------------------------------");

for(let i=0;i<final.player4.length;i++)
{
    Queue.enqueue(final.player4[i]);
}
console.log(Queue.printQueue());
